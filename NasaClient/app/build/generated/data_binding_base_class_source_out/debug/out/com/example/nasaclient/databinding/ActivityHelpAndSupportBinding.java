...
public final class ActivityHelpAndSupportBinding implements ViewBinding {
  ...
  private ActivityHelpAndSupportBinding(@NonNull LinearLayout rootView, @NonNull Button button,
  ...
  public static ActivityHelpAndSupportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHelpAndSupportBinding((LinearLayout) rootView, button, main, titleText);
    }
