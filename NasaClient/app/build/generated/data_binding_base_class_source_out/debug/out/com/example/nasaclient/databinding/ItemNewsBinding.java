...
public final class ItemNewsBinding implements ViewBinding {
  ...
  private ItemNewsBinding(@NonNull LinearLayout rootView, @NonNull TextView dateTextView,
  ...
  public static ItemNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNewsBinding((LinearLayout) rootView, dateTextView, descriptionTextView,
